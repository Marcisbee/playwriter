...
import { IconIdle, IconLoad, IconPass, IconFail, IconSkip } from '../utils/icons.jsx';
...
export function ProjectTest({ cwd }) {
  ...
  async function runTests() {
    ...
    const proc = await os.spawnProcess(`PLAYWRIGHT_FORCE_TTY=0 FORCE_COLOR=0 ./tasks.sh test --grep=${JSON.stringify(`/${grep}/`)}`, { cwd });
    setProc(proc);
  }
